  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#1A211D] transition-colors duration-300">
      ...
      <nav className={`fixed top-0 left-0 right-0 w-full z-50 transition-all duration-300 ${
        isScrolled ? 'bg-white/90 dark:bg-[#323E38]/90 backdrop-blur-xl shadow-lg' : 'bg-transparent'
      }`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            >
              ...
              <span className="text-lg sm:text-xl md:text-2xl font-bold" style={{
                background: 'linear-gradient(to right, #258D55, #30B66E, #64C74C)',
            ...
            <div className="hidden lg:flex gap-8 items-center">
              <a href="#features" className="text-[#59625C] dark:text-[#AEB4B0] hover:text-[#258D55] dark:hover:text-[#49CF87] transition-colors font-medium">{t.features}</a>
              <a href="#download" className="text-[#59625C] dark:text-[#AEB4B0] hover:text-[#258D55] dark:hover:text-[#49CF87] transition-colors font-medium">{t.download}</a>
              <a href="#about" className="text-[#59625C] dark:text-[#AEB4B0] hover:text-[#258D55] dark:hover:text-[#49CF87] transition-colors font-medium">{t.about}</a>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            <span className="text-[#258D55] dark:text-[#49CF87] font-semibold">{t.platformTag}</span>
          </motion.div>
          ...
          >
            {t.heroSubtitle1}<br />
            <span className="font-semibold text-[#258D55] dark:text-[#49CF87]">{t.heroSubtitle2}</span>
          </motion.p>
            ...
            {[
              ...
              >
                <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-6" style={{
                  background: 'linear-gradient(to bottom right, #C9ECC1, #A8E09A)'
                }}>
                  <item.icon className="w-7 h-7 text-[#258D55]" />
                </div>
                <h3 className="text-xl font-semibold mb-3 text-[#1A211D] dark:text-white">{item.title}</h3>
                <p className="text-[#59625C] dark:text-[#AEB4B0]">{item.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-2xl font-semibold mb-3 text-[#1A211D] dark:text-white">{feature.title}</h3>
                <p className="text-[#59625C] dark:text-[#AEB4B0] leading-relaxed">{feature.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section id="download" className="py-24 bg-gradient-to-br from-[#EBF8E8] via-[#C9ECC1] to-[#FFF5E0] dark:from-[#1B653D]/20 dark:via-[#2A5D1D]/20 dark:to-[#AD7200]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* App Preview Section */}
          <motion.div 
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#1A211D] dark:text-white">
              {t.downloadTitle1}<br />{t.downloadTitle2}
            </h2>
          ...
          <div className="rounded-3xl overflow-hidden shadow-2xl" style={{
            background: 'linear-gradient(to bottom right, #30B66E, #64C74C, #4CAB35)'
          }}>
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-white font-medium text-sm md:text-base">{t.freeDownload}</p>
                      <p className="text-white/80 text-xs md:text-sm">{t.freeDownloadDesc}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-white font-medium text-sm md:text-base">{t.globalService}</p>
                      <p className="text-white/80 text-xs md:text-sm">{t.globalServiceDesc}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-white font-medium text-sm md:text-base">{t.safePlatform}</p>
                      <p className="text-white/80 text-xs md:text-sm">{t.safePlatformDesc}</p>
                    </div>
                  </div>
                </div>
              </motion.div>
                ...
                >
                  ...
                  <div className="relative bg-white rounded-3xl p-6 md:p-8 shadow-2xl group-hover:scale-105 transition-all duration-300">
                    <div className="text-center mb-4 md:mb-6">
                      <p className="text-[#258D55] font-bold text-lg md:text-xl mb-2">{t.qrCode}</p>
                      <p className="text-[#59625C] text-xs md:text-sm leading-relaxed">
                        {t.scanToDownload}<br />
                        <span className="text-xs text-[#8D948F]">{t.scanWithCamera}</span>
                      </p>
                    </div>
                    ...
                    <div className="mt-4 md:mt-6 flex items-center justify-center gap-2 text-[#258D55]">
                      ...
                      <span className="text-xs md:text-sm font-semibold">{t.downloadNow}</span>
                    </div>
                  </div>
                </a>
      ...
      {/* Vision Section */}
      <section id="about" className="py-24 bg-gradient-to-br from-[#F6F8F7] to-white dark:from-[#323E38] dark:to-[#1A211D]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            className="text-center mb-16"
            initial={{ opacity: 0, y: 20 }}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div className="text-4xl font-bold text-[#258D55] dark:text-[#49CF87] mb-2">{stat.number}</div>
                <div className="text-xl font-semibold text-[#1A211D] dark:text-white mb-2">{stat.label}</div>
                <p className="text-[#59625C] dark:text-[#AEB4B0]">{stat.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-2xl font-bold" style={{
                  background: 'linear-gradient(to right, #49CF87, #64C74C, #A8E09A)',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                  backgroundClip: 'text'
                }}>WanduGo</span>
              </div>
              <p className="text-[#AEB4B0] mb-4 max-w-md">
                {t.footerDesc}
              </p>
              <p className="text-[#8D948F] text-sm">
                {t.footerTagline}
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-[#AEB4B0]">
                ...
                <li><a href="#" className="hover:text-white transition-colors">{t.groupBuying}</a></li>
                <li><a href="#" className="hover:text-white transition-colors">{t.usedMarket}</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-[#AEB4B0]">
                <li><a href="#" className="hover:text-white transition-colors">{t.intro}</a></li>
                <li><a href="#" className="hover:text-white transition-colors">{t.team}</a></li>
                <li><a href="#" className="hover:text-white transition-colors">{t.invest}</a></li>
                <li><a href="mailto:canada.jellyjo@gmail.com" className="hover:text-white transition-colors">{t.contactUs}</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-[#59625C] pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex gap-6 text-sm text-[#8D948F]">
                ...
                <a href="mailto:canada.jellyjo@gmail.com" className="hover:text-white transition-colors">{t.contactUs}</a>
              </div>
            </div>
          </div>
        </div>
